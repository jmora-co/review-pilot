...
| Mode                        | What it does                                                                         |
| --------------------------- | ------------------------------------------------------------------------------------ |
| Guided (`guided`)           | Recommends each resolution; no-change replies can be approved and sent immediately. |
| Auto Review (`auto-local`)  | Resolves and verifies every eligible thread locally. No commit or push.              |
| Auto Pilot (`auto-publish`) | Resolves, verifies, commits, pushes, replies, and closes eligible threads.           |
